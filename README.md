...
**CR8** é uma plataforma completa de gestão de relacionamento com clientes (CRM) que ajuda equipes de vendas a serem mais produtivas e organizadas.

### Por que escolher CR8?
...
1. Acesse o repositório: [github.com/thaleslaray/CR8](https://github.com/thaleslaray/CR8)
2. Clique no botão **Fork** (canto superior direito)
3. Escolha sua conta pessoal ou organização
4. Aguarde o fork ser criado

> ✅ **Pronto quando**: Você ver o repositório `CR8` na sua conta do GitHub
...
4. Na lista de repositórios, encontre e selecione **CR8** (seu fork)
5. Clique em **Deploy**

> ⏱️ **Aguarde**: O deploy leva cerca de 2-3 minutos

6. Quando terminar, você verá uma mensagem de sucesso
7. **Copie a URL** do seu projeto (ex: `https://CR8-abc123.vercel.app`)
...
O CR8 tem estas áreas principais:
...
O CR8 tem dois tipos de usuários:
...
- 🐛 **Problemas**: Abra uma [issue no GitHub](https://github.com/thaleslaray/CR8/issues)
...
git clone https://github.com/thaleslaray/CR8.git
cd CR8
